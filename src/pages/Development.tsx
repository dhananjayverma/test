...
import DevelopmentPage from "../inc/DevelopmentPage";
            ...
            <div className={styles.frameContainer}>
              <div className={styles.frameParent2}>
                ...
                <div className={styles.buttonParent}>
                  <h2 className={styles.button}>Get Started with Development</h2>
                  <div className={styles.chooseYourContext2}>
                    Set up your development environment—access code, packages, and documentation.
                  </div>
                </div>
              </div>
