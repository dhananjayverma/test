...
const CheckboxCode: FunctionComponent<ContainerType> = ({ className = "" }) => {
            ...
            <section className={styles.frameParent} id="code">
              <div className={styles.codeParent}>
                ...
                <div className={styles.importTheButton}>
                  Import the Checkbox component from the HBK component library. All interactive states (hover, focus, active, disabled) are handled automatically. 
                </div>
              </div>
