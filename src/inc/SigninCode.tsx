...
const SigninCode: FunctionComponent<ContainerType> = ({ className = "" }) => {
            ...
            <section className={styles.frameParent} id="code">
              <div className={styles.codeParent}>
                ...
                <div className={styles.importTheButton}>
                  Import the Sign In template from the HBK template library. The template provides a standardized authentication experience with built-in responsive layouts, accessibility support, and consistent form behavior across products. 
                </div>
              </div>
