...
import styles from "./ColorGrayAccessibility.module.css";
        ...
        <div className={styles.content}>
          <section className={styles.section} id="accessibility">
            <div className={styles.sectionHeader}>
              ...
              <p className={styles.sectionText}>As Brand color, the HBK Product Grey Blue color should comply to the color accessibility standards. While using this color, we should ensure:  </p>
          ...
          <section className={styles.section} id="color-contrast">
            <div className={styles.sectionHeader}>
              ...
              <p className={styles.sectionText}>HBK Product Teal Blue color ensures color contrast ratio &gt; 4.5: 1 for all Normal and Large Text Check the results color contrast result below:</p>
            </div>
            <div className={styles.tableCard}>
              ...
              {contrastRows.map((row) => (
                <div className={styles.tableRow} key={row.label}>
                  ...
                  <div className={styles.resultCell}>
                    <span className={styles.failBadge}>{row.darkIcon}</span>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className={styles.tableTypeCard}>
              <div className={styles.tableHeader}>
                ...
                <div className={styles.headerCell}>On Light grey (#FAFAFA)</div>
                <div className={styles.headerCell}>On Light grey 2 (#F4F4F5)</div>
              </div>
            ...
            <div className={styles.sectionContentSplit}>
              <div className={styles.textBlock}>
                ...
                <p className={styles.sectionText}>
                  To comply with our specially-abled users, the HBK Product grey Blue color is also tested for Color Blindness Test.    
                </p>
                <p className={styles.sectionText}>
              ...
              <div className={styles.previewCard}>
                <div className={styles.imgWrapper}>
                  <img src="./gray-test.svg" alt="Color blindness preview" />
                </div>
                <p>A quick preview of Color Blindness test for HBK Product grey Blue color</p>
              </div>
            </div>
          </section>
        </div>
