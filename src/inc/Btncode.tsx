...
const Buttoncode: FunctionComponent<ContainerType> = ({ className = "" }) => {
            ...
            <section className={styles.frameParent} id="code">
              <div className={styles.codeParent}>
                ...
                <div className={styles.importTheButton}>
                  The Button library is hosted on Github and Storybook as a repo. These can be easily downloaded and used by the developers. 
                </div>
              </div>
