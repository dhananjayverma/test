...
import styles from "./ColorTealPalettes.module.css";
...
const paletteItems = [
  { label: "brand 50", hex: "#E6F7F7", textColor: "#000" },
  { label: "brand 100", hex: "#B3E6E6 ", textColor: "#000" },
  { label: "brand 200", hex: "#80D4D4", textColor: "#000" },
  { label: "brand 300", hex: "#4DC2C2", textColor: "#000" },
  { label: "brand 400", hex: "#26B3B3", textColor: "#000" },
  { label: "brand 500", hex: "#009999", textColor: "#000" },
  { label: "brand 600 (Base)", hex: "#008080", textColor: "#fff" },
  { label: "brand 700", hex: "#006D6D", textColor: "#fff" },
  { label: "brand 800", hex: "#005959", textColor: "#fff" },
  { label: "brand 900", hex: "#003D3D", textColor: "#fff" },
];
          ...
          <section className={styles.section} id="usage-guidelines">
            <div className={styles.sectionHeader}>
              ...
              <p className={styles.sectionText}>
                Base colors form the foundation of HBK’s visual identity. For Data Acquisition Tools, the teal blue reflects connection and real-time interaction, drawing from its association with sensors, signals, and instrumentation. It supports interfaces that deal with continuous input and monitoring, helping users quickly interpret incoming data and stay oriented in complex environments.</p>
                <p className={styles.sectionText}>When combined with other design elements, this color helps create a balanced and responsive experience that feels both technical and approachable.
              </p>
            </div>
