...
import styles from "./ColorDarkAccessibility.module.css";
        ...
        <div className={styles.content}>
          <section className={styles.section} id="accessibility">
            <div className={styles.sectionHeader}>
              ...
              <p className={styles.sectionText}>As Brand color, the HBK Brand Dark Blue color should comply to the color accessibility standards. While using this color, we should ensure:  </p>
          ...
          <section className={styles.section} id="color-contrast">
            <div className={styles.sectionHeader}>
              ...
              <p className={styles.sectionText}>HBK Product Dark Blue color ensures color contrast ratio &gt; 4.5: 1 for all Normal and Large Text Check the results color contrast result below:</p>
            </div>
            ...
            <div className={styles.sectionContentSplit}>
              <div className={styles.textBlock}>
                ...
                <p className={styles.sectionText}>
                  To comply with our specially-abled users, the HBK Product Dark Blue color is also tested for Color Blindness Test.   
                </p>
                <p className={styles.sectionText}>
              ...
              <div className={styles.previewCard}>
                <div className={styles.imgWrapper}>
                  <img src="./dark-test.svg" alt="Color blindness preview" />
                </div>
                <p>A quick preview of Color Blindness test for HBK Product Dark Blue color</p>
              </div>
            </div>
          </section>
        </div>
