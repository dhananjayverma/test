...
import styles from "./ColorTealAccessibility.module.css";
        ...
        <div className={styles.content}>
          <section className={styles.section} id="accessibility">
            <div className={styles.sectionHeader}>
              ...
              <p className={styles.sectionText}>As Brand color, the HBK Product Teal Blue color should comply to the color accessibility standards. While using this color, we should ensure: </p>
            ...
            <div className={styles.tableCard}>
              ...
              {contrastRows.map((row) => (
                <div className={styles.tableRow} key={row.label}>
                  ...
                  <div className={styles.resultCell}>
                    <span className={styles.largeBadge}>{row.darkText}</span>
                  </div>
                  <div className={styles.resultCell}>
            ...
            <div className={styles.sectionContentSplit}>
              <div className={styles.textBlock}>
                ...
                <p className={styles.sectionText}>
                  To comply with our specially-abled users, the HBK Product Teal Blue color is also tested for Color Blindness Test.   
                </p>
                <p className={styles.sectionText}>
              ...
              <div className={styles.previewCard}>
                <img src="./teal-test.svg" alt="Color blindness preview" />
                <p>A quick preview of Color Blindness test for HBK Product Teal Blue color</p>
              </div>
            </div>
          </section>
        </div>
